...
export const metadata = { title: `Integrações | Dashboard | ${config.site.name}` } satisfies Metadata;
  ...
  */
  {
    id: 'INTEG-002',
    title: 'GitHub',
    description: 'O GitHub é um serviço de hospedagem baseado na web para controle de versão de código usando o Git.',
